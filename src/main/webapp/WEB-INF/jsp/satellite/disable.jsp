				...
				<div class="alert alert-info alert-dismissible fade show d-none" role="alert">
		  		...
		  		<div class='card'>
				    <div class='card-header'>
				        <h5 class="text-danger">Sta per essere applicata la procedura di emergenza. Si è sicuri di voler procedere ?</h5> 
				    </div>
				   
				    <div class='card-body'>
				   		 <h6>Numero Voci Totali presenti nel sistema: ${satellite_count_all_attribute} </h6> 
				   		 <h6>Numero Voci che verrano modificate in seguito alla procedura: ${satellite_count_modify_attribute }</h6>
				                	...
				                	<c:forEach items="${satellite_list_attribute }" var="satelliteItem">
										<tr>
											...
											<td>
												...
												<c:if test="${satelliteItem.stato == 'IN_MOVIMENTO' || satelliteItem.stato == 'FISSO' || satelliteItem.getDataLancio() == null }">
				        ...
				        <div class="col-12">
					        ...
					        <form:form method="post" action="disable" class="row g-3" novalidate="novalidate">
					        	 <button class="btn btn-danger fa fa-chevron-left"> Conferma </button>
					        </form:form>
